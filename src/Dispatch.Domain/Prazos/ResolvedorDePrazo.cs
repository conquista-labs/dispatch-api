...
public static class ResolvedorDePrazo
{
    ...
    public static ResolucaoPrazo Resolver(
        Escrevente escrevente, Etapa etapa, DateTimeOffset referencia, IReadOnlyCollection<Equipe> equipes)
    {
        ...
        return equipe is null
            ...
            : new ResolucaoPrazo(equipe.PrazoPara(etapa, referencia), equipe, SemEquipeSinalizado: false);
    }
}

...
internal sealed class TagDescriptionsDocumentTransformer : IOpenApiDocumentTransformer
{
    public Task TransformAsync(OpenApiDocument document, OpenApiDocumentTransformerContext context, CancellationToken cancellationToken)
    {
        document.Tags = new HashSet<OpenApiTag>
        {
            ...
            new() { Name = OpenApiTags.Dashboard, Description = "KPIs, score e desempenho por período (RF-42 a RF-46). Administrador vê tudo; Distribuidora sem nível, score nem faixa (RF-43a); Conferente só os próprios números." },

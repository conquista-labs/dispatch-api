...
| `docs/decisions/` (ADR-0001 a 0046) | Antes de mudar um comportamento que parece estranho — pode ser decisão registrada. Índice abaixo |
...
- **Importação e prazos**: 0005 CSV com PDF fora · 0006 linha de corte, `Numero` nunca único · 0007
  ...
  em horas corridas + dia útil · 0037 corte de horário por equipe+etapa · 0045 conector de relatório
  do cartório (.xls) como adaptador.
- **Protocolo e conferência**: 0011 carga calculada na leitura · 0016 pedido de reabertura · 0019
  ...
  recalcula vencimento · 0035 ajuste manual de duração · 0038 nº da conferência na leitura · 0046 pool em
  ordem obrigatória e limite de atos na mão (escrevente escondido na Minha fila).
- **Dados e leitura**: 0004 remover conferente é soft delete · 0009 aprendizado sem `evento_decisao` ·
  ...
  0041 período do Dashboard por calendário · 0042 metas e pesos do score na Configuração (aplicados na
  leitura) · 0043 tempo de referência por tipo calculado na leitura (peso decimal) · 0044 ritmo só dos
  atos concluídos.

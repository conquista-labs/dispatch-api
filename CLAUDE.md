...
| `docs/decisions/` (ADR-0001 a 0041) | Antes de mudar um comportamento que parece estranho — pode ser decisão registrada. Índice abaixo |
...
- **Dados e leitura**: 0004 remover conferente é soft delete · 0009 aprendizado sem `evento_decisao` ·
  ...
  0041 período do Dashboard por calendário.
